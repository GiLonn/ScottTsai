...
class MFSAN(nn.Module):
    ...
    def forward(self, data_src, test_flag, data_tgt, label_src,mu1, mu2, mu3, mark = 1):
        mmd_loss = 0
        ...
        if self.training == True:
            ...
            if mark == 1:
                ...
                return data_src, data_tgt_son1, data_tgt_label1, cls_loss, transfer_loss, l1_loss / 2
            ...
            if mark == 2:
                ...
                return data_src, data_tgt_son2, data_tgt_label2, cls_loss, transfer_loss, l1_loss / 2
            ...
            if mark == 3:
                ...
                return data_src, data_tgt_son3,data_tgt_label3, cls_loss, transfer_loss, l1_loss / 2
