...
class conv_M1(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        self.branch3_4 = nn.Dropout(0.15)
...
class conv_M2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        self.branch1_2_2 = Pointwise_conv2d(96, 96, stride = 1, padding = 1, dilation = 1)
        ...
        self.branch2_2_2 = Pointwise_conv2d(96, 96, stride = 1, padding = 2, dilation = 2)
...
class resnet18_multi(nn.Module):
    def __init__(self,use_att = True, block = BasicBlock, layers = [2, 2, 2, 2], num_classes = 2):
        ...
        convm2_list = [conv_M2(128, 256)]
        att_list = [att.eca_layer(128)]
        #tt_list = [GCT.GCT(128)]
        att_list2 = [GCT.GCT(256)]
        ...
        self.linear_test = BasicConv2d(256, 256, kernel_size = 1, stride =1)
