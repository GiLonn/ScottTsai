...
if __name__ == '__main__':
    ...
    #sample_source_train_1 = torch.from_numpy(np.load(pa_source_train1))
    #sample_source_train1_label = torch.from_numpy(np.load(pa_source_train1_label))
    #sample_source_train_2 = torch.from_numpy(np.load(pa_source_train2))
    #sample_source_train2_label = torch.from_numpy(np.load(pa_source_train2_label))
    #sample_target_train = torch.from_numpy(np.load(pa_target_train))
    #sample_target_train_label = torch.from_numpy(np.load(pa_target_train_label))
