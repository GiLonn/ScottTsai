...
#import ECANet_2 as att2
import CBAM_sp as att2
#import GCN
#import SK
#import GCT
#import AA
...
class conv_M2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        #att_list = [att.CBAM(320)]
        #self.att_layer = att.CBAM(320)
...
class resnet18_multi(nn.Module):
    def __init__(self,use_att = False, block = BasicBlock, layers = [2, 2, 2, 2], num_classes = 2):
        ...
        self.first_conv = BasicConv2d(128, 256, kernel_size = 3, stride = 1, padding = 1)
        #self.second_conv = BasicConv2d(256, 256, kernel_size = 3, stride = 1, padding = 1)

        

        #self.res = conv1x1(256, 320)
        #att_list = [att.eca_layer(128)]
        #att_list2 = [att2.eca_layer(320)]
        #att_list2 = [att2.eca_layer(320)]
        att_list2 = [att2.CBAM(320)]
        #self.dr = nn.Dropout(0.15)


        #tt_list = [GCT.GCT(128)]
        #att_list2 = [GCT.GCT(320)]
        #att_list = [AA.DoubleAttentionLayer(128, 128, 128)]
        ...
        #self.convm2_layer2 = nn.Sequential(*convm2_list2)
        ...
        self.linear_test = BasicConv2d(320, 256, kernel_size = 1, stride =1, padding = 0)
        #self.linear_test = conv1x1(320, 256)
