...
class conv_M2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        att_list1 = [att.eca_layer(96)]
        self.att_layer1 = nn.Sequential(*att_list1)
        att_list2 = [att2.eca_layer(128)]
        self.att_layer2 = nn.Sequential(*att_list1)
        self.branch1_4 = nn.Dropout(0.2)
        ...
        att_list3 = [att.eca_layer(96)]
        self.att_layer3 = nn.Sequential(*att_list3)
        att_list4 = [att2.eca_layer(128)]
...
class resnet18_multi(nn.Module):
    def __init__(self,use_att = True, block = BasicBlock, layers = [2, 2, 2, 2], num_classes = 2):
        ...
        convm2_list = [conv_M2(256, 512)]
        #att_list = [att.CBAM(512)]
        #tt_list = [GCT.GCT(128)]
    ...
    def forward(self, x, test_flag):
        ...
        #print("self.layer3.weight", self.layer3.weight)
        #if self.use_att:
            #res = x
            #x = self.att_layer(x)
            #x = x + res
