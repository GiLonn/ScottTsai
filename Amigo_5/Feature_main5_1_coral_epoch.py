...
if __name__ == '__main__':
    ...
    sample_source_train = torch.from_numpy(np.load('source_train_feature.npy'))
    ...
    sample_source_train_label = torch.from_numpy(np.load('source_train_feature_label.npy'))
    ...
    sample_target_train = torch.from_numpy(np.load('target_train_feature.npy'))
    ...
    sample_target_train_label = torch.from_numpy(np.load('target_train_feature_label.npy'))
