...
def load_testing(root_path, dir, kwargs, batch_size = 1):
    ...
    return test_loader
'''
model_root_path = 'E:/ScottTsai/res_multi/auto_hyperparameter/implicit/temp/'
model_layer_path = 'imp_v3_add3_with_kmm_dr_5Layer/'
class_path = 'record/muskmelon/to/pear/'
...
target_test_layer = "muskmelon_to_/to_pear/"
...
model = Net()
print(model.base_network.convm2_layer[0])
target_layers = [model.base_network.linear_test]
