...
if '1_to_4_average' not in goal_excel.sheetnames:
    create_excel_sheet = goal_excel.create_sheet("1_to_4_average")

all_result_sheet = goal_excel.get_sheet_by_name('All_accuracy')



target_com_list = [1234, 1235, 1236, 1237, 1238, 1245, 1246, 1247, 1248, 1256, 1257, 1258, 1267, 1268, 1278, 2345, 2346,
                   2347, 2348, 2356, 2357, 2358, 2367, 2368, 2378, 3456, 3457, 3458, 3467, 3468, 3478, 4567, 4568, 4578,
                   5678, 1345, 1346, 1347, 1348, 1356, 1357, 1358, 1367, 1368, 1378, 2456, 2457, 2458, 2467, 2468, 2478, 3567,
                   3568, 3578, 4678, 1456, 1457, 1458, 1467, 1468, 1478, 2567, 2568, 2578, 3678, 1567, 1568, 1578, 2678, 1678]
...
ws = goal_excel.get_sheet_by_name("1_to_4_average")
...
for row_index in range(5, 108, 13):
    ...
    for q in target_com_list:
        ...
        value_4_pos = all_result_sheet.cell(row=row_index, column=index_4).value
        ...
        diff_4_pos = all_result_sheet.cell(row=row_index, column=(index_4 + 1)).value


        avg_pos = (value_1_pos + value_2_pos + value_3_pos + value_4_pos) / 4
        avg_diff_pos = (diff_1_pos + diff_2_pos + diff_3_pos + diff_4_pos) / 4
        ...
        value_4_total = all_result_sheet.cell(row=(row_index + 1), column=index_4).value
        ...
        diff_4_total = all_result_sheet.cell(row=(row_index + 1), column=(index_4 + 1)).value


        avg_total = (value_1_total + value_2_total + value_3_total + value_4_total) / 4
        avg_diff_total = (diff_1_total + diff_2_total + diff_3_total + diff_4_total) / 4
