...
class conv_M2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, **kwargs):
        super(conv_M2, self).__init__()
        self.res = conv1x1(in_channels, 512)
        ...
        self.branch1_2_2 = Pointwise_conv2d(96, 160, stride = 1, padding = 1, dilation = 1)
        self.branch1_3_1 = Depthwise_conv2d(160, kernel_size = 3, stride = 1, padding = 1, dilation = 1)
        self.branch1_3_2 = Pointwise_conv2d(160, 160, stride = 1, padding = 1, dilation = 1)
        ...
        self.branch2_2_2 = Pointwise_conv2d(96, 160, stride = 1, padding = 2, dilation = 2)
        self.branch2_3_1 = Depthwise_conv2d(160, kernel_size = 3, stride = 1, padding = 2, dilation = 2)
        self.branch2_3_2 = Pointwise_conv2d(160, 160, stride = 1, padding = 2, dilation = 2)
        ...
        self.branch3_1 = BasicConv2d(in_channels, 96, kernel_size = 1, stride = 1)
        self.branch3_2 = Deconv2d(96, 96, kernel_size = 3, stride = 1, padding = 1, dilation = 1, groups = 4)
        self.branch3_3 = Deconv2d(96, 96, kernel_size = 3, stride = 1, padding = 1, dilation = 1, groups = 4)
        self.branch3_4 = Deconv2d(96, 128, kernel_size = 3, stride = 1, padding = 1, dilation = 1, groups = 4)
        #self.branch3_5 = nn.Dropout(0.2)
    ...
    def forward(self, x):
        ...
        x_branch1 = self.branch1_4_1(x_branch1)
...
class conv_M2_2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        self.branch1_3_2 = Pointwise_conv2d(128, 192, stride = 1, padding = 1, dilation = 1)
        self.branch1_4 = nn.Dropout(0.2)
        ...
        self.branch2_3_2 = Pointwise_conv2d(128, 192, stride = 1, padding = 2, dilation = 2)
        self.branch2_4 = nn.Dropout(0.2)
...
class resnet18_multi(nn.Module):
    def __init__(self,use_att = True, block = BasicBlock, layers = [2, 2, 2, 2], num_classes = 2):
        self.inplanes = 64  
        ...
        convm2_list = [conv_M2(128, 512)]
        att_list = [att.eca_layer(128)]
        #convm2_list_2 = [conv_M2_2(256, 512)]
        ...
        self.linear_test = BasicConv2d(512, 256, kernel_size = 1, stride =1)
        #self.linear_test2 = BasicConv2d(512, 256, kernel_size = 1, stride =1)

        #self.linear_test = conv1x1(480, 256)
