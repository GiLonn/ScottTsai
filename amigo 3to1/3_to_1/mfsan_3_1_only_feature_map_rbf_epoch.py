...
if __name__ == '__main__':
    ...
    KMM_weight_source1_pred = KMM_Lin_pred_rbf.compute_kmm(opt.pa_train_source_1, opt.pa_train_target, opt.pa_train_source_1_label)
    KMM_weight_source2_pred = KMM_Lin_pred_rbf.compute_kmm(opt.pa_train_source_2, opt.pa_train_target, opt.pa_train_source_2_label)    
    KMM_weight_source3_pred = KMM_Lin_pred_rbf.compute_kmm(opt.pa_train_source_3, opt.pa_train_target, opt.pa_train_source_3_label)    
