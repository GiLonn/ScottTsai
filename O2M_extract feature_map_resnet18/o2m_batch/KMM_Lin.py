...
def compute_kmm():
    ...
    sample_source_train_all = torch.from_numpy(np.load('source_train_feature.npy'))
    sample_source_train_label_all = torch.from_numpy(np.load('source_train_feature_label.npy'))
